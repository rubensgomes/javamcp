...
class JavaParser(JavaParserBase):
    ...
    def compilationUnit(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                while (
                    (((_la - 1)) & ~0x3F) == 0
                    and ((1 << (_la - 1)) & -7313370881793359615) != 0
                ) or (
                    (((_la - 66)) & ~0x3F) == 0
    ...
    def genericInterfaceMethodDeclaration(self):
        ...
        try:
            ...
            while (
                (((_la - 1)) & ~0x3F) == 0
                and ((1 << (_la - 1)) & -7313371715285743615) != 0
            ) or (
                (((_la - 66)) & ~0x3F) == 0
                and ((1 << (_la - 66)) & -8935141660703064061) != 0
            ):
                self.state = 613
                self.interfaceMethodModifier()
                self.state = 618
    ...
    def typeIdentifier(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            if not (
                (((_la) & ~0x3F) == 0 and ((1 << _la) & 1513308810947723264) != 0)
                or _la == 66
                or _la == 129
            ):
                self._errHandler.recoverInline(self)
        ...
        try:
            ...
            if la_ == 1:
                ...
                if (
                    (
                        (((_la - 17)) & ~0x3F) == 0
                        and ((1 << (_la - 17)) & 1858725164630021) != 0
                    )
                    or _la == 124
                    or _la == 129
                ):
